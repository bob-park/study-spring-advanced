...
public class ProxyFactoryConfigV2 {
    ...
    @Bean
    public OrderControllerV2 orderControllerV2(OrderServiceV2 orderServiceV2, LogTrace trace) {
    ...
    @Bean
    public OrderServiceV2 orderServiceV2(OrderRepositoryV2 orderRepositoryV2, LogTrace trace) {
