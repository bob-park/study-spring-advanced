package hello.proxy.configure.v3_proxyfactory;
...
public class ProxyFactoryConfigV1 {
    ...
    @Bean
    public OrderControllerV1 orderControllerV1(OrderServiceV1 orderServiceV1, LogTrace trace) {
    ...
    @Bean
    public OrderServiceV1 orderServiceV1(OrderRepositoryV1 orderRepositoryV1, LogTrace trace) {
